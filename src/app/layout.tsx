      ...
      <body className="min-h-screen flex flex-col">
        <LanguageProvider>
          ...
          <nav className="bg-[#f7f9f6]/80 dark:bg-dark-card/80 backdrop-blur-xl border-b border-sand/60 dark:border-dark-border sticky top-0 z-50 transition-colors duration-200" role="navigation" aria-label="Main navigation">
            <div className="mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-3 sm:py-4 flex items-center justify-between">
          ...
          <main id="main-content" className="flex-1 mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 py-6 sm:py-10 w-full" tabIndex={-1}>
